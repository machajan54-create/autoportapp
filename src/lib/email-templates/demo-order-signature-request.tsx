    ...
    <Body style={styles.body}>
      <Container style={styles.container}>
        ...
        <Section style={styles.content}>
          ...
          <Text style={styles.lead}>
            připravili jsme pro Vás objednávku předváděcího vozu <strong>{modelVerze}</strong> (č.{" "}
            {orderNumber}). Pro dokončení prosím podepište dokument digitálně přes níže uvedený
            odkaz.
          </Text>
          <Hr style={styles.hr} />
          ...
          {expiresAt ? (
            <Text style={styles.metaRow}>
              Platnost odkazu: {new Date(expiresAt).toLocaleDateString("cs-CZ")}
            </Text>
          ) : null}
        </Section>
        <Footer />
...
export const template = {
  ...
  previewData: {
    ...
    signUrl: "https://www.autoport-app.cz/sign/xxx",
