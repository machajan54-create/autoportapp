        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.lead}>
              Stále evidujeme nepotvrzenou zakázku k mytí (upozornění č. {reminderNumber}).
              Prosíme o potvrzení nebo odmítnutí — víme tak, jestli s tím počítáte.
            </Text>
            {meta.length > 0 ? (
...
export const template = {
  ...
  subject: (d: Record<string, any>) =>
    `Připomínka mytí${d?.vozidlo ? ` – ${d.vozidlo}` : ''}`,
